...
class TestInsert:
    ...
    def test_batch_insert(
        self, test_dataset: Dataset, vector_documents: List[Dict],
    ):
    ...
    def test_numpy_upload(
        self, test_dataset: Dataset, numpy_documents: List[Dict],
    ):
        results = test_dataset._insert_documents(
    ...
    def test_pandas_upload(
        self, test_dataset: Dataset, pandas_documents: List[Dict],
    ):
        results = test_dataset._insert_documents(
