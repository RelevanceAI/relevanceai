...
class TestSentenceSplitterOps:
    def test_split_text(self, test_client: Client):
        ops = SentenceSplitterOps(credentials=test_client.credentials)
    ...
    def test_split_text_document(self, test_client: Client):
        ops = SentenceSplitterOps(credentials=test_client.credentials)
        document = {
            "status": 0,
            "params": {
