...
class NearestNeighbours(Base, DocUtils):
    ...
    def get_nearest_neighbours(
        ...
        if callable_distance:
            ...
            sort_key = [1-spatial_distance.cosine(i, vector) for i in doc_utils.get_field_across_documents(vector_field, docs)]
            reverse = True
        ...
        return sorted(docs, reverse=reverse, key=lambda x: x['nearest_neighbour_distance'])
