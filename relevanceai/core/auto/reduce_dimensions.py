...
class DimensionalityReduction(Write):
    def _run_dr_algorithm(
        ...
        if algorithm == "PCA":
            from relevanceai.core.dr.dim_reduction import PCA

            model = PCA()
        elif algorithm == "TSNE":
            from relevanceai.core.dr.dim_reduction import TSNE

            model = TSNE()
        elif algorithm == "UMAP":
            from relevanceai.core.dr.dim_reduction import UMAP

            model = UMAP()
        elif algorithm == "IVIS":
            from relevanceai.core.dr.dim_reduction import Ivis
