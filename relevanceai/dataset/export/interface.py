...
class Export(CSVExport, DictExport, PandasExport):
    ...
    @track
    def to_dataset(self, child_dataset_id: str, filters: list=None, filter_condition: Callable=None, chunksize: int=20):
        """Export this current dataset to another dataset
        """
        for i, chunk in enumerate(self.chunk_dataset(chunksize=chunksize, filters=filters)):
        ...
        self.datasets.post_metadata(dataset_id=child_dataset_id, metadata={"parent_dataset_id": self.dataset_id})
