...
ENDPOINTS = list(requests.get(
    "https://gateway-api-aueast.relevance.ai/latest/openapi.json").json()['paths'].keys())
NOT_NEEDED_ENDPOINTS = ['/datasets/infer_schema',
...
endpoint_in_sdk = []
endpoint_not_in_sdk = [endpoint for endpoint in ENDPOINTS if endpoint not in NOT_NEEDED_ENDPOINTS]
