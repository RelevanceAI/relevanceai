...
Dashboard <https://cloud.tryrelevance.com/demo/search/image-to-text>`__.
...
-  Project & API Key (The SDK will link you to the corresponding page or
   you can grab your API key from https://cloud.tryrelevance.com/ in the
   settings area)
-  Python 3
-  Relevance AI Installed as shown below. For more information visit
   `Installation guide <https://docs.tryrelevance.com/docs>`__
...
`dashboard <https://cloud.tryrelevance.com/dataset/quickstart_clip/dashboard/monitor/vectors>`__.
...
`here <https://docs.tryrelevance.com/docs/hybrid-search>`__.
