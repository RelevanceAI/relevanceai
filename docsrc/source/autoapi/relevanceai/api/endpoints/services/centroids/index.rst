:py:mod:`relevanceai.api.endpoints.services.centroids`
======================================================

.. py:module:: relevanceai.api.endpoints.services.centroids
...
.. py:class:: CentroidsClient(project, api_key)
   ...
   .. py:method:: list_furthest_from_center(self, dataset_id: str, vector_fields: List[str], alias: str, centroid_vector_fields: List = [], cluster_ids: List = [], select_fields: List = [], approx: int = 0, sum_fields: bool = True, page_size: int = 1, page: int = 1, similarity_metric: str = 'cosine', filters: List = [], facets: List = [], min_score: int = 0, include_vector: bool = False, include_count: bool = True, include_facets: bool = False)
